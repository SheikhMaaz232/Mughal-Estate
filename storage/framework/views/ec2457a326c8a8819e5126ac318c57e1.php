...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            ...
            <a href="<?php echo e(route('companies.create')); ?>" class="btn btn-sm btn-primary">Add New</a>
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td><?php echo e($company['name_eng']); ?></td>
                    <td><?php echo e($company['name_ur']); ?></td>
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <!-- Delete Form -->
                            <form method="POST" action="<?php echo e(route('companies.destroy', $company->id)); ?>" class="d-inline-block delete-form">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\icon-villas\resources\views/companies/index.blade.php ENDPATH**/ ?>