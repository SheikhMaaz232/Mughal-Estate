            ...
            <div class="col-sm-6 col-md-6 mx-auto">
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="name_eng" maxlength="100" name="name_eng" value="{{ old('name_eng') }}">
                        @error('name_eng')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="father_name_eng" name="father_name_eng" maxlength="100" value="{{ old('father_name_eng') }}" >
