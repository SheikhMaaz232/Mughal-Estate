    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-1">Schedule Periods</h1>
                <h2 class="fs-base lh-base fw-medium text-muted mb-0">List of all schedule periods</h2>
            </div>
            <a href="{{ route('periods.create') }}" class="btn btn-sm btn-primary">Add New</a>
