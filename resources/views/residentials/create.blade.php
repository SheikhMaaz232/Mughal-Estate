...
<div class="block block-rounded col-md-12">
    <div class="block-header block-header-default">
        <h3 class="block-title">Add Residential Type</h3>
    </div>
    <div class="block-content block-content-full">

        <form action="{{ route('residentials.store') }}" method="POST">
            @csrf
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('residentials.index') }}" class="btn btn-sm btn-alt-primary">Cancel</a>
            </div>
        </form>
    </div>
</div>
