    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-1">Banks</h1>
                <h2 class="fs-base lh-base fw-medium text-muted mb-0">List of all banks</h2>
            </div>
            <a href="{{ route('banks.create') }}" class="btn btn-sm btn-primary">Add New</a>
                ...
                @foreach($banks as $bank)
                    <tr>
                        ...
                        <div class="btn-group">
                            ...
                            <!-- Delete Form -->
                            <form method="POST" action="{{ route('banks.destroy', $bank->id) }}" class="d-inline-block delete-form">
                                @csrf
                                @method('DELETE')
