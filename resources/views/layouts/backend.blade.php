    ...
    <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed main-content-narrow">
        ...
        <div class="js-sidebar-scroll">
            ...
            <ul class="nav-main">
                ...
                <ul class="nav-main-submenu">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('projects.index') ? ' active' : '' }}" href="{{ route('projects.index') }}">
                            <span class="nav-main-link-name">Projects</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('cities.index') ? ' active' : '' }}" href="{{ route('cities.index') }}">
                            <span class="nav-main-link-name">City</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('residentials.index') ? ' active' : '' }}" href="{{ route('residentials.index') }}">
                            <span class="nav-main-link-name">Residential Type</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('banks.index') ? ' active' : '' }}" href="{{ route('banks.index') }}">
                            <span class="nav-main-link-name">Bank</span>
                        </a>
                    </li>
                      <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('periods.index') ? ' active' : '' }}" href="{{ route('periods.index') }}">
                            <span class="nav-main-link-name">Schedule Period</span>
                        </a>
                    </li>
                    </li>
                      <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('casts.index') ? ' active' : '' }}" href="{{ route('casts.index') }}">
                            <span class="nav-main-link-name">Cast Management</span>
                        </a>
                    </li>
                      <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->routeIs('warehouses.index') ? ' active' : '' }}" href="{{ route('warehouses.index') }}">
        ...
        <div class="content-header">
            ...
            <form class="d-none d-md-inline-block" action="/dashboard" method="POST">
                ...
                <div class="d-flex align-items-center px-2 text-dark fw-bold">
                    @if(isset($selectedCompany))
                        <img src="{{ asset('storage/companies/' . $selectedCompany->image) }}"
                            alt="Logo"
                            style="height: 30px; width: auto; margin-right: 10px;" />

                        <span>{{ $selectedCompany->name_en }}</span>
                    @else
            ...
            <div class="dropdown d-inline-block ms-2">
                ...
                <span class="d-none d-sm-inline-block ms-2">{{ \Auth::user()->name_eng }}</span>
                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block ms-1 mt-1"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
                <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset('media/avatars/avatar10.jpg') }}" alt="">
                    <p class="mt-2 mb-0 fw-medium">{{ \Auth::user()->name_eng }}</p>
